...
/**
 * Interface that talks with the database and keeps track of people's address
 * information
 * 
 * @author jjwyse
 * 
...
public interface AddressBookJdbcDao
{
     ...
     * 
     * @param id
     *            The ID of the person to add to the database
     * @param person
     ...
     * 
     * @param id
     *            The ID of the person from the address book
     * 
     ...
     * 
     * @param id
     *            ID of the person we're going to update
     * @param person
     *            The new person to store
     */
